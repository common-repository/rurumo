...
function rurumo_notification($file_name, $plugin_data) {
	...
	if (($rurumo[$plugin_pack]->package != null) && ($rurumo[$plugin_pack]->installed == false)) {
		...
		echo "Перевод этого плагина вы можете скачать с сайта <a href='".$rurumo[$plugin_pack]->package."'>l10n-ru.googlecode.com</a> или <a href='$url'>установить автоматически</a>.";		
		echo '</div></td></tr>';
	}
